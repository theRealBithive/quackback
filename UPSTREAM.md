...
| `30d9bc805` #540 | 2026-09-11 | feat(mcp): scoped OAuth with write-implies-read (better-auth 1.7.4, migration 0279)             | planned, batch B                                                                                                                               | —                         |
| `0db59438c` #541 | 2026-09-11 | fix(auth): label social callback failures as oauth, not SSO                                     | planned, batch B                                                                                                                               | —                         |
| `06e7de186` #542 | 2026-09-11 | fix(e2e): bust caches with IN and retarget post-MCP-move specs                                  | planned, batch B                                                                                                                               | —                         |
| `8b38983dc` #543 | 2026-09-11 | test(mcp): fail if a resource ships without a 403 mapping                                       | planned, batch B                                                                                                                               | —                         |
| `98b18e3ee`      | 2026-09-11 | feat(widget): pair the agent install so the signing secret never hits chat                      | planned, batch B                                                                                                                               | —                         |
| `0935071a6` #545 | 2026-09-11 | feat(ui): migrate overlay primitives from Radix to Base UI                                      | planned, batch C                                                                                                                               | —                         |
| `ee44b03ba` #545 | 2026-09-11 | fix(inbox): keep composer focus across send                                                     | planned, batch C                                                                                                                               | —                         |
| `ebe630799` #545 | 2026-09-11 | perf(editor): cut per-keystroke work in post and comment composers                              | planned, batch C                                                                                                                               | —                         |
| `94dcab894` #545 | 2026-09-11 | fix(pr-545): address Codex review feedback                                                      | planned, batch C                                                                                                                               | —                         |
| `48045ccc3` #545 | 2026-09-11 | fix(pr-545): resolve follow-up review threads                                                   | planned, batch C                                                                                                                               | —                         |
| `c926b53f3` #545 | 2026-09-11 | fix(pr-545): resolve second review round                                                        | planned, batch C                                                                                                                               | —                         |
| `9a92f530e` #545 | 2026-09-11 | fix(billing): give the branding checkbox its own label path                                     | planned, batch C (the checkbox primitive, not billing)                                                                                         | —                         |
| `4aa245e63` #546 | 2026-09-11 | refactor: simplification batch, dead-code sweep and shared building blocks                      | planned, batch C                                                                                                                               | —                         |
| `e31eb058b` #546 | 2026-09-11 | refactor: share taxonomy validators, ticket slugs, and attribute fn schemas                     | planned, batch C                                                                                                                               | —                         |
| `0c9255422` #546 | 2026-09-11 | refactor: share nextPosition, attribute types, and webhook safe-dispatch                        | planned, batch C                                                                                                                               | —                         |
| `99fb7a1d2` #547 | 2026-09-12 | feat(widget): scope sessions by audience (migration 0280)                                       | planned, batch D                                                                                                                               | —                         |
| `5cd9c0c11` #550 | 2026-09-12 | fix(auth): pre-insert MCP oauth_resource before Better Auth seed                                | planned, batch B (needed with 1.7.4)                                                                                                           | —                         |
| `74b480a2a` #551 | 2026-09-12 | fix(auth): keep OIDC sign-out local to Quackback                                                | planned, batch B (needed with 1.7.4; Zitadel logout)                                                                                           | —                         |
