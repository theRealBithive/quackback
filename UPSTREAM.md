...
| `99fb7a1d2` #547 | 2026-09-12 | feat(widget): scope sessions by audience (migration 0280)                                       | picked; migration 0280 kept its upstream number and `when`, the numbering has re-converged                                                     | #34, `v0.13.3-exkulpa.31` |
...
| `615e4da2b`      | 2026-09-13 | fix(inbox): skip non-list cache entries when patching posts                                     | skipped, fixed here first in #14 (`d20bda577`, 2026-09-05) and more completely; upstream's per-page shape check adopted separately             | #34, `v0.13.3-exkulpa.31` |
