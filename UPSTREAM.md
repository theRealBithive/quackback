...
| `99fb7a1d2` #547 | 2026-09-12 | feat(widget): scope sessions by audience (migration 0280)                                       | picked, one deliberate divergence: an unrecognised audience reads as portal-tier, not `dashboard`; 0280 kept its number and `when`             | #34, `v0.13.3-exkulpa.31` |
