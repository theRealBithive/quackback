...
describe('MentionPicker', () => {
  it('renders each item by display name', () => {
    renderWithIntl(<MentionPicker items={items} command={() => {}} />)
  ...
  it('invokes command(item) when a row is clicked', () => {
    const command = vi.fn()
    renderWithIntl(<MentionPicker items={items} command={command} />)
  ...
  it('shows empty state when items is empty', () => {
    renderWithIntl(<MentionPicker items={[]} command={() => {}} />)
  ...
  it('re-selects the first row when items change', () => {
    ...
    const { rerender } = renderWithIntl(
      <MentionPicker ref={ref} items={items} command={() => {}} />
    )
